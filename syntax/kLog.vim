...
"""syntax region  klogDomain         start=/begin_domain/ end=/end_domain/ contains=klogSignature
syntax match   klogSignature      /\w/
syntax match   klogSeparator      /::\|\./
syntax keyword klogKeywords       begin_domain end_domain signature extensional intensional nextgroup=klogSignature,klogSeparator skipwhite
...
syntax cluster prologAll          contains=prologList,prologPredicate,prologTuple,@prologTerms,@prologComments,prologQuoted,@prologBuiltIn,prologRelations,prologArithmetic,prologDiffList,prologSeparator
...
highlight link prologSeparator    Type

highlight link klogKeywords       Type
highlight link klogSeparator      Type
highlight link klogSignature      Function
